...
@Component({
  selector: 'app-blogs-main-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './blogs-main-section.component.html',
  styleUrl: './blogs-main-section.component.css'
})
export class BlogsMainSectionComponent implements OnInit{
