...
@Component({
  selector: 'app-about-html-section',
  imports: [CommonModule,FormsModule,ReactiveFormsModule,QuillModule],
  templateUrl: './about-html-section.component.html',
  styleUrl: './about-html-section.component.css'
})
export class AboutHtmlSectionComponent implements OnInit {
