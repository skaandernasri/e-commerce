...
@Component({
  selector: 'app-content6-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './content6-section.component.html',
  styleUrl: './content6-section.component.css'
})
export class Content6SectionComponent implements OnInit{
