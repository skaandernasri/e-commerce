...
@Component({
  selector: 'app-content2-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './content2-section.component.html',
  styleUrl: './content2-section.component.css'
})
export class Content2SectionComponent implements OnInit{
