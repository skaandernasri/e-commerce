...
@Component({
  selector: 'app-content4-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './content4-section.component.html',
  styleUrl: './content4-section.component.css'
})
export class Content4SectionComponent implements OnInit{
