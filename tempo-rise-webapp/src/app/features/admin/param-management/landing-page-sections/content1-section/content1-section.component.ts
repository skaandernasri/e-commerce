...
@Component({
  selector: 'app-content1-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './content1-section.component.html',
  styleUrl: './content1-section.component.css'
})
export class Content1SectionComponent implements OnInit {
