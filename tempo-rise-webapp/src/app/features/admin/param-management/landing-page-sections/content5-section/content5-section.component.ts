...
@Component({
  selector: 'app-content5-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './content5-section.component.html',
  styleUrl: './content5-section.component.css'
})
export class Content5SectionComponent implements OnInit{
