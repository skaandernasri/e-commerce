...
@Component({
  selector: 'app-dar-html-section',
  imports: [CommonModule,FormsModule,ReactiveFormsModule,QuillModule],
  templateUrl: './dar-html-section.component.html',
  styleUrl: './dar-html-section.component.css'
})
export class DarHtmlSectionComponent implements OnInit {
