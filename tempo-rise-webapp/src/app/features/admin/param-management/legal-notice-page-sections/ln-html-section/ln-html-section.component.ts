...
@Component({
  selector: 'app-ln-html-section',
  imports: [CommonModule,FormsModule,ReactiveFormsModule,QuillModule],
  templateUrl: './ln-html-section.component.html',
  styleUrl: './ln-html-section.component.css'
})
export class LnHtmlSectionComponent implements OnInit {
