...
@Component({
  selector: 'app-products-main-section',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './products-main-section.component.html',
  styleUrl: './products-main-section.component.css'
})
export class ProductsMainSectionComponent implements OnInit{
